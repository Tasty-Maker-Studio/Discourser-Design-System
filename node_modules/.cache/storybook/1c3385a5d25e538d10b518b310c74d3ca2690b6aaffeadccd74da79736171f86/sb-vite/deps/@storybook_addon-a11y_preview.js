...
// node_modules/.pnpm/@storybook+addon-a11y@8.6.15_storybook@8.6.15_prettier@3.7.4_/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = defaultParameters) => {
  let { default: axe } = await import("./axe-OR4AVMTX.js"), { element = "body", config = {}, options = {} } = input, htmlElement = document.querySelector(element) ?? document.body;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-2TJ3XL5F.js");
