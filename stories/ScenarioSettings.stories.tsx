      ...
      'conversation-flow': (
        <Box p="4" bg="surface.container.low" borderRadius="l3">
          ...
          <p style={{ color: '#5E5F59', fontSize: '14px' }}>
            Custom adjustment controls for Conversation Flow will be injected
            here from the application layer. This demonstrates the injectable
            content API.
          </p>
        </Box>
      ),
    ...
    renderAdjustmentDialog: (sectionId) => (
      <Box p="4" bg="surface.container.low" borderRadius="l3">
        ...
        <p style={{ fontSize: '14px', color: '#5E5F59' }}>
          Rendered via the renderAdjustmentDialog render-prop. Section ID:{' '}
          {sectionId}
        </p>
      </Box>
    ),
